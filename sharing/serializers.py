...
# from rest_framework import serializers
# from .models import Book, BookView, BookLike, BookComment, BookCommentLike
#
#
...
#     class Meta:
#         model = Book
#         exclude = ('updated_at', 'is_banned', 'is_active', 'owner_type',)
...
#
#
# class BookCommentLikeSerializer(serializers.ModelSerializer):
#     class Meta:
