...
urlpatterns = [
    ...
    path('login/', LoginAPIViewSet.as_view({'post': 'login'}), name='login'),
    path('refresh/', RefreshTokenViewSet.as_view({'post': 'refresh_token'}), name='refresh_token'),
    path('me/', ProfileViewSet.as_view({'get': 'user_detail'}), name='user_detail'),
    path('<int:pk>/', OtherProfileViewSet.as_view({'get': 'other_user_detail'}), name='other_user_detail'),
    path('me/update/', UpdateUserViewSet.as_view({'patch': 'user_update'}), name='user_update'),
]
